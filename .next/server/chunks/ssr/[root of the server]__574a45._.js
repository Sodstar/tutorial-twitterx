...
const Products = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].models.Products || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].model("products", ProductSchema);
}}),
...
const /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getCachedProducts = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["unstable_cache"])(async ()=>{
    try {
        ...
        const products = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$productMongo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Products"].find({});
        return products;
    } catch (error) {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ getProductById(productId) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongoose$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connectDB"])();
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$productMongo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Products"].findById(productId);
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ checkExistingProduct(name) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongoose$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connectDB"])();
        return await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$productMongo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Products"].findOne({
            name
        });
    } catch (error) {
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ createProduct(name, price, description) {
    try {
        ...
        const newProduct = new __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$productMongo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Products"]({
            name,
            price,
            description
        });
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ updateProduct(productId, updateData) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongoose$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connectDB"])();
        const updatedProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$productMongo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Products"].findByIdAndUpdate(productId, updateData, {
            new: true
        });
...
async function /*#__TURBOPACK_DISABLE_EXPORT_MERGING__*/ deleteProduct(productId) {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mongoose$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["connectDB"])();
        const deletedProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$productMongo$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["Products"].findByIdAndDelete(productId);
...
;
async function page() {
    const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$actions$2f$product$2e$action$2e$tsx__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getCachedProducts"])();
    console.log(res);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__574a45._.js.map